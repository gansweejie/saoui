...
!(function (a, b) {
  ...
  function c() {
    d.READY ||
      (s.determineEventTypes(),
      r.each(d.gestures, function (a) {
        u.register(a);
      }),
      s.onTouch(d.DOCUMENT, n, u.detect),
      s.onTouch(d.DOCUMENT, o, u.detect),
      (d.READY = !0));
  }
  ...
  (d.VERSION = "1.1.3"),
    ...
    (d.IS_MOBILE = /mobile|tablet|ip(ad|hone|od)|android|silk/i.test(
      navigator.userAgent
    )),
    (d.NO_MOUSEEVENTS =
      (d.HAS_TOUCHEVENTS && d.IS_MOBILE) || d.HAS_POINTEREVENTS),
  ...
  var r = (d.utils = {
    ...
    s = (d.event = {
        ...
        var f = this,
          g = function (e) {
            var g,
              ...
              j = r.inStr(h, "mouse");
            (j && f.preventMouseEvents) ||
              (j && b == m && 0 === e.button
                ? ((f.preventMouseEvents = !1), (f.shouldDetect = !0))
                : i && b == m
                ? (f.shouldDetect = 1 === e.buttons || t.matchType(k, e))
                : j ||
                  b != m ||
                  ((f.preventMouseEvents = !0), (f.shouldDetect = !0)),
              i && b != o && t.updatePointer(b, e),
              f.shouldDetect && (g = f.doDetect.call(f, e, b, a, c)),
              g == o &&
                ((f.preventMouseEvents = !1), (f.shouldDetect = !1), t.reset()),
              i && b == o && t.updatePointer(b, e));
          };
      ...
      collectEventData: function (a, b, c, d) {
        var e = k;
        return (
          r.inStr(d.type, "mouse") || t.matchType(j, d)
            ? (e = j)
            : t.matchType(l, d) && (e = l),
          {
    ...
    t = (d.PointerEvent = {
      ...
      getTouchList: function () {
        var a = [];
        return (
          r.each(this.pointers, function (b) {
            a.push(b);
          }),
          a
        );
      ...
      matchType: function (a, b) {
        ...
        var c = b.pointerType,
          d = {};
        return (
          (d[j] = c === (b.MSPOINTER_TYPE_MOUSE || j)),
    ...
    u = (d.detection = {
      ...
      getCalculatedData: function (a, b, c, e, f) {
        var g = this.current,
          ...
          j = g.lastCalcData;
        i &&
          a.timeStamp - i.timeStamp > d.CALCULATE_INTERVAL &&
          ((b = i.center),
          (c = a.timeStamp - i.timeStamp),
          (e = a.center.clientX - i.center.clientX),
          (f = a.center.clientY - i.center.clientY),
          (h = !0)),
          (a.eventType == q || a.eventType == p) && (g.futureCalcEvent = a),
          (!g.lastCalcEvent || h) &&
            ((j.velocity = r.getVelocity(c, e, f)),
      ...
      extendEventData: function (a) {
        var b = this.current,
          c = b.startEvent,
          d = b.lastEvent || c;
        (a.eventType == q || a.eventType == p) &&
          ((c.touches = []),
          r.each(a.touches, function (a) {
  ...
  (d.Instance = function (a, b) {
    ...
    c(),
      (this.element = a),
      (this.enabled = !0),
      r.each(b, function (a, c) {
        delete b[c], (b[r.toCamelCase(c)] = a);
      }),
      (this.options = r.extend(r.extend({}, d.defaults), b || {})),
      this.options.behavior &&
        r.toggleBehavior(this.element, this.options.behavior, !0),
      (this.eventStartHandler = s.onTouch(a, m, function (a) {
        e.enabled && a.eventType == m
          ? u.startDetect(e, a)
          : a.eventType == q && u.detect(a);
      })),
      (this.eventHandlers = []);
  }),
    (d.Instance.prototype = {
      ...
      off: function (a, b) {
        var c = this;
        return (
          s.off(c.element, a, b, function (a) {
      ...
      trigger: function (a, b) {
        ...
        var e = this.element;
        return (
          r.hasParent(b.target, e) && (e = b.target), e.dispatchEvent(c), this
        );
      },
      enable: function (a) {
      ...
      dispose: function () {
        var a, b;
        for (
          r.toggleBehavior(this.element, this.options.behavior, !1), a = -1;
          ...
          switch (b.eventType) {
            ...
            case n:
              ...
              if (
                e.name != a &&
                ((e.name = a),
                d.options.dragDistanceCorrection && b.distance > 0)
              ) {
              ...
              ((d.options.dragBlockVertical && q) ||
                (d.options.dragBlockHorizontal && !q)) &&
                b.preventDefault();
              break;
            case p:
              c &&
      ...
      function b(b, d) {
        ...
        switch (b.eventType) {
          ...
          case n:
            ...
            break;
          case o:
            !r.inStr(b.srcEvent.type, "cancel") &&
    ...
    (d.gestures.Touch = {
      ...
      handler: function (a, b) {
        return b.options.preventMouse && a.pointerType == j
          ? void a.stopDetect()
